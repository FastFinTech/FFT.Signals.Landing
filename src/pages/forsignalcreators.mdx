...
**Blurb about system using limit orders instead of market orders

** Can edit order details before the order is filled. Entry/SL/TP. *

** Communicate with followers via "diary entries".
